...
namespace BridgeLabzTraining.Scenario_oops.CustomFurnitureMnufacturing
{
    ...
    {
        private IFurniture utilityFurniture;

        public void Menu()
        {
            utilityFurniture = new FurnitureUtility();
            ...
            while (true)
            {
                ...
                {
                    case 1:
                        Console.WriteLine($"Maximum profit for 12 ft rod is {utilityFurniture.Profit(12)}");
                        break;
                    case 2:
                        Console.WriteLine("Enter waste");
                        int waste = Convert.ToInt32(Console.ReadLine());
                        Console.WriteLine($"Maximum profit for 12 ft rod is {utilityFurniture.ProfitWithWaste(12,waste)}");
                        break;
                    case 3:
                        ...
                        Console.WriteLine($"Maximum profit for 12 ft rod is {utilityFurniture.ProfitWithWaste(lengthRod, wasteUser)}");
                        break;
                    case 4:
